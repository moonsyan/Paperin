...
/* quiet-workspace 新增主题与其主题级排版尺度（仅作用于 mist/pine） */
import './styles/themes/mist.css'
import './styles/themes/pine.css'
import './styles/themes/code-palette-light.css'
import './styles/themes/code-palette-dark.css'
import './styles/code-syntax.css'
import './styles/quiet-workspace.css'
...
import './styles/components/document-pathbar.css'
