    ...
    <>
      ...
      {workspaceAvailable && (
        <button
          ...
          aria-pressed={workspaceThemeEnabled}
          onClick={() => onWorkspaceThemeEnabledChange(!workspaceThemeEnabled)}
        >
          <span className="settings-label">
            当前工作区独立主题
            <span className="settings-hint">关闭时跟随全局主题</span>
          </span>
          <span className={`switch ${workspaceThemeEnabled ? 'on' : ''}`} />
        </button>
      )}
