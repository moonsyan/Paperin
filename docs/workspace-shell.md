...
当前质量面板已按文章评估来源基线，旧全局快照保留为归属未知。2026-09-23 另确认草稿/库外身份、异步登记与改名/移动路径迁移仍有缺陷（A02/A03/A08）；监听故障与索引释放不得短暂显示成全部健康（A04）。布局与可见契约见 [UI 规范](UI-INTERACTION-SPEC.md)，新鲜阻断见 [项目状态](PROJECT-STATUS.md)。
