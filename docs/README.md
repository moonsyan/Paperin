...
| P1 | S05 保存语义与 UI 残项 | 部分完成 | 真实中文 IME、9 主题、100/125/150% 缩放、焦点和旧回执全矩阵 |
| P1 | S06 五分钟激活与兼容试开 | 未开始 | Q04 来源夹具原文/附件 hash 100% 不变；10/12 独立激活任务成功 |
| P1 | S07 中文搜索与覆盖解释 | 未开始 | R01 Hit@5≥90%、尾部精确命中 100%、5000 文件首批结果 P95≤800ms |
| P1 | S08 搜索结果到当前文章 | 未开始 | Q05 来源/位置/撤销矩阵通过，R02 至少 10/12 成功且中位耗时改善≥30% |
| P1 | S09 跨会话恢复与回访 | 未开始 | 两次真实重启、改名/删除/同名路径和旧异步响应均不串文档；5 名试用者次日独立继续 |
| P1 | S10 核心导出与预检 | 未开始 | 12 篇合成文档×4 格式×承诺平台通过，失败不覆盖原文件且依赖预检明确 |
| P1 | S11 任务模板与成果引导 | 未开始 | 两个模板任务完成率、首次成果时间和导出路径有可复现实测 |
