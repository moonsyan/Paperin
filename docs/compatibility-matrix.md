...
| 常见来源合成兼容夹具（P1-02） | `src/main/testing/fixtures/compatibility/` | `compatibility-fixtures.test.ts` | 已有：Typora/标准 MD、Obsidian 子集、Notion MD+CSV、思源、语雀各 ≥10 篇合成样本；只读索引前后 hash 不变；路径限制在夹具根内 | 真实导出版本矩阵、Electron 只读 smoke、五分钟用户任务为 **UNVERIFIED** |
